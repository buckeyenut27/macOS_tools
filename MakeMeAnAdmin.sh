...
# count down from 15 minutes and then create  #
...
osascript -e 'display dialog "You now have administrative rights for 15 minutes. DO NOT ABUSE THIS PRIVILEGE..." buttons {"Okay"} default button 1'
